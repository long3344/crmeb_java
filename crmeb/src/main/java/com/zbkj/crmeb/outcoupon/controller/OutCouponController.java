...
public class OutCouponController {
    ...
    public CommonResult<CommonPage<OutCoupon>> getList(@Validated PageParamRequest pageParamRequest) {
        CommonPage<OutCoupon> outCouponCommonPage = CommonPage.restPage(outCouponService.getList(pageParamRequest));
